...
export function SiteHeader() {
  ...
  // While the menu is open the white panel supplies the background, so text goes dark.
      ...
      <header
        className={cn(
          ...
          solid
            ...
            : cn("bg-transparent border-b border-transparent", light ? "text-cream" : "text-ink")
        )}
      >
        <div className="mx-auto flex h-16 lg:h-20 max-w-[1360px] items-center justify-between px-5 lg:px-10">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            <Link
              href="/cart"
              className={cn("relative flex h-11 w-11 items-center justify-center rounded-full transition-colors", light ? "hover:text-olympic-yellow" : "hover:text-ink/60")}
            ...
            <button
              ...
              className={cn("group flex items-center gap-3 rounded-full py-1 pl-3 pr-1 transition-colors", light ? "hover:text-olympic-yellow" : "hover:text-ink/60")}
            >
              <span className="text-sm tracking-wide">{menuOpen ? "Close" : "Menu"}</span>
              <span className={cn("relative flex h-10 w-10 items-center justify-center rounded-full border group-hover:border-olympic-yellow transition-colors", light ? "border-cream/40" : "border-ink/25")} aria-hidden="true">
